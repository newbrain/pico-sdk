...
// PICO_CONFIG: PICO_DEFAULT_I2C_SDA_PIN, Define the default I2C SDA pin, min=0, max=NUM_BANK0_GPIOS - 1, default=Usually provided via board header, group=hardware_i2c
// PICO_CONFIG: PICO_DEFAULT_I2C_SCL_PIN, Define the default I2C SCL pin, min=0, max=NUM_BANK0_GPIOS - 1, default=Usually provided via board header, group=hardware_i2c
