...
// PICO_CONFIG: PICO_DEFAULT_UART_TX_PIN, Define the default UART TX pin, min=0, max=NUM_BANK0_GPIOS - 1, default=Usually provided via board header, group=hardware_uart
// PICO_CONFIG: PICO_DEFAULT_UART_RX_PIN, Define the default UART RX pin, min=0, max=NUM_BANK0_GPIOS - 1, default=Usually provided via board header, group=hardware_uart
